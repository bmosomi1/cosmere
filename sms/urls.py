...
urlpatterns = [
    ...
    path('phone-number/payment/verification', views.phone_verify_payment, name='phone_verify_payment'),
    ...
    # path('home/land', views.return_home_land_data)

    path('experiential/payments', views.experiential_payments, name='experiential_payments'),

    # mpesa
    path('lipa/na/mpesa/online', views.lipa_na_mpesa_online, name="lipa_na_mpesa_online")
]